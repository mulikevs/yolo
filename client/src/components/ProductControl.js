...
class ProductControl extends Component {
    ...
    componentDidMount(){
        axios.get('http://yolo-backend/api/products')
            .then(res =>{
                console.log(res)
                this.setState({
    ...
    handleAddingNewProduct = (newProduct) =>{
        ...
        // }       
        // console.log(...formData)
        axios.post('http://yolo-backend/api/products', newProduct)
    ...
    handleDeletingProduct = (id) =>{
        axios.delete('http://yolo-backend/api/products/'+id)
            .then(res => console.log(res.data))
            .catch((error) =>{
                console.log(error)
            })
    ...
    handleEditingProduct = (editedProduct) =>{
        ...
        axios.put('http://yolo-backend/api/products/' + this.state.selectedProduct._id, editedProduct)
            .then(res =>console.log(res.data))
